...
import 'package:seven_taxis_app/src/pages/client/register/client_register_controller.dart';
class ClientRegisterPage extends StatefulWidget {
  const ClientRegisterPage({super.key});

  @override
  State<ClientRegisterPage> createState() => Client_RegisterPageState();
}

class Client_RegisterPageState extends State<ClientRegisterPage> {
