...
class _DriverTravelCalificationPageState extends State<DriverTravelCalificationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _con.travelHistory == null
          ? Center(child: CircularProgressIndicator()) // Muestra un indicador de carga si los datos no están listos
          : Column(
        children: [
          _bannerPriceInfo(),
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              Text(
                'Valor del viaje',
                 // Mostrar 'N/A' si el precio es nulo
                style: TextStyle(
                  fontSize: 16,
                ),
              ),
