...
import 'package:seven_taxis_app/src/pages/driver/travel_request/driver_travel_request_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          _bannerClientInfo(),
          _textFromTo(_con.from, _con.to), // Mostrar los valores después de asegurarse que no sean nulos
          _textTimeLimit()
        ],
      ),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              from.isNotEmpty ? from : 'Cargando...', // Mostrar un texto alternativo si aún no se ha cargado
          ...
          Container(
            margin: EdgeInsets.symmetric(horizontal: 30),
            child: Text(
              to.isNotEmpty ? to : 'Cargando...', // Mostrar un texto alternativo si aún no se ha cargado
              style: TextStyle(fontSize: 17),
              maxLines: 2,
            ),
          ),
