...
import '../../client/history_detail/client_history_detail_controller.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
         children: [
           ...
           _listTileInfo('Mi calificacion', _con.travelHistory?.calificationDriver?.toString() ?? '', Icons.star_border),
           _listTileInfo('Calificacion del cliente', _con.travelHistory?.calificationClient?.toString() ?? '', Icons.star),
